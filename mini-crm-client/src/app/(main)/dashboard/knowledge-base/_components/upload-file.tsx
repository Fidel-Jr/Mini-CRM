...
import { AddCustomerForm } from "./upload-file-form"
    ...
    <Sheet>
      ...
      <SheetContent className="!w-full sm:!w-[500px] !max-w-none sm:!max-w-none rounded-t-2xl sm:rounded-2xl shadow-xl">
        <SheetHeader className="pb-6 border-b border-gray-100">
          <SheetTitle className="text-2xl font-bold">Upload Document</SheetTitle>
          <SheetDescription className="text-gray-600 text-base">
            Upload new document here. Click save when you&apos;re done.
          </SheetDescription>
        </SheetHeader>
        <AddCustomerForm />
      </SheetContent>
