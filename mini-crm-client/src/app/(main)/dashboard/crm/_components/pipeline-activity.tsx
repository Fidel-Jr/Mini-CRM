...
export function PipelineActivity({
    ...
    const totalLeads = trend.reduce((sum, item) => sum + item.total, 0);
            ...
            <Card className="xl:col-span-12">
                ...
                <CardContent>
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
                        ...
                        >
                            <BarChart data={trend} barSize={40}>
                                ...
                                <ChartTooltip
                                    content={
                                        <ChartTooltipContent labelKey="label" nameKey="total" />
                                    }
                                />
                            ...
                            <div className="rounded-lg border p-4">
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="mt-2 flex justify-between text-xs">
                                        <div>
                                            <span className="font-medium">{summary.won}</span>
                                            {" "}won
                                        </div>

                                        <div className="text-muted-foreground">
                                            {summary.qualified} opportunities
                                        </div>
                                    </div>
                                </div>
                            </div>
